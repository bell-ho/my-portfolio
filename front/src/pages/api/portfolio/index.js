...
export const removePortfolio = async (params) => {
  await axios.delete(`${apiKey.portfolios}/${params}`);
};

export const updatePortfolio = async (params) => {
  await axios.put(`${apiKey.portfolios}/${params.id}`, params);
};
...
export const updatePortfolioImage = async (params) => {
  await axios.put(`${apiKey.portfolios}/image/${params.id}`, params);
};

export const updatePortfolioAbout = async (params) => {
  await axios.put(`${apiKey.portfolios}/about/${params.id}`, params);
};
